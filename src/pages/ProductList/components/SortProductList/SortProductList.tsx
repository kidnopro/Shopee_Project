        ...
        <div className='flex items-center flex-wrap gap-2'>
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize rounded-sm ', {
              'bg-orange-500 text-white hover:bg-orange/80': isActiveSortBy(sortBy.view),
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize  rounded-sm', {
              'bg-orange-500 text-white hover:bg-orange/80': isActiveSortBy(sortBy.createdAt),
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize  rounded-sm', {
              'bg-orange-500 text-white hover:bg-orange/80': isActiveSortBy(sortBy.sold),
          ...
          <select
            className={classNames('h-8 px-4 text-left text-sm capitalize outline-none  rounded-sm', {
              'bg-orange-500 text-white hover:bg-orange-600': isActiveSortBy(sortBy.price),
